...
class BusinessesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UISearchResultsUpdating, FiltersViewControllerDelegate{
    ...
    var  searchCategory:UISearchController!
    ...
    override func viewDidLoad() {
        ...
        searchCategory = UISearchController(searchResultsController: nil)
        searchCategory.searchResultsUpdater = self

       searchCategory.searchBar.sizeToFit()
        
        navigationItem.titleView = searchCategory.searchBar
        searchCategory.hidesNavigationBarDuringPresentation = false
...
*/
    ...
    func updateSearchResultsForSearchController(searchBarController: UISearchController) {
       ...
       search_Category = businesses
    }
            
    if let searchText = searchBarController.searchBar.text {
        if(searchText == "") {
            businesses = search_Category
